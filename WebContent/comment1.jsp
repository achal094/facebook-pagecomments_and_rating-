...
<div class="container-fluid">
  <div class="row content">
    ...
    <br>
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li align=center class="active"><a href="comment1.jsp">Comment</a></li>
  ...
  <div >
  <br>
      <h2 align=center>All the Comments of Facebook Page - "Dance Society,DTU"</h2>
	<hr>
      <h4 align=center><small>All Comments</small></h4>
      <hr>
      <% 
      short a=1;
      short b=2;
      ...
      out.println("<h3>&nbspCommented BY : " +name+"</h3>");     
      out.println("<h5>&nbsp "+date+"</h5>");
      out.println("<h5> &nbsp Comment ID : "+cid+"</h5>");
      out.println("&nbsp Comment message : "+ message);
      out.println("<hr>");
